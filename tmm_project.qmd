...
2차 분석. 2개 기업으로 축소해서 정교화. RccpMeCab 활용. 데이터셋 수집 어렵다면 무신사 중심으로 방향 전환 가능.
빅카인즈, 위키 크롤링 데이터셋 확보할 수 있는 방향으로. rvest 이용.
키워드 '무신사'와 '패션 플랫폼 NOT 무신사, cat 서비스-쇼핑'로 전체 플랫폼에서 무신사 차별점과 전략 분석.
...
#                user_dic = data.frame(term="트렌비", tag='ncn'),
#                category_dic_nms=c('brand'))
